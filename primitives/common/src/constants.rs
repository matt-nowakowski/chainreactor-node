...
// 200ms blocks for DOOM demo (default production: 6000)
pub const MILLISECS_PER_BLOCK: u32 = 200;
pub const BLOCKS_PER_MINUTE: BlockNumber = 60_000 / (MILLISECS_PER_BLOCK as BlockNumber); // 300
